...
def Barchart (Title0,Xaxis0,Xalues0,Yaxis0,Yalues0):
    plt.figure()
    ...
    plt.ylabel(Yaxis0)
    plt.title(Title0)
    plt.savefig("Frontend/React/me/public/images/UserBar.png")
    return 'done'
...
def ScatterChart(Title1,Xaxis1,Xalues1,Yaxis1,Yalues1):
    ...
    plt.ylabel(Yaxis1)
    plt.title(Title1)
    plt.savefig("Frontend/React/me/public/images/UserScatter.png")
    return 'done'
...
def Histogram(Title2,Values,Xaxis2="",Yaxis2=""):
    ...
    plt.ylabel(Yaxis2)
    plt.title(Title2)
    plt.savefig("Frontend/React/me/public/images/UserHistogram.png")
    return 'done'
...
def linePlot(Title3,Xaxis3,Xalues3,Yaxis3,Yalues3):
    ...
    plt.ylabel(Yaxis3)
    plt.title(Title3)
    plt.savefig("Frontend/React/me/public/images/UserLine.png")
    return 'done'
...
def Piechart (Title4,Names,amount):
    ...
    plt.title(Title4)
    plt.savefig("Frontend/React/me/public/images/UserPie.png")
    return 'done'
