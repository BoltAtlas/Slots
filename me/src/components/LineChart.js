...
function UserForm() {
  ...
  return (
    ...
    <form type="submit" onSubmit={handleSubmit} >
      <div>
        <label htmlFor="Title0">Title for this LineChart: </label>
      ...
      <div>
        <label htmlFor="Xaxis0">Xaxis Name for this LineChart: </label>
        <input type="text" autoComplete='off'
        placeholder='Years'
      ...
      <div>
        <label htmlFor="Xalues0">Xaxis Values for this LineChart: </label>
        <input type="text" autoComplete='off'
      ...
      <div>
        <label htmlFor="Yaxis0">Yaxis Name for this LineChart: </label>
        <input type="text" autoComplete='off'
        placeholder='Amount'
      ...
      <div>
        <label htmlFor="Yalues0"> Yaxis Values0 for this LineChart: </label>
        <input type="text" autoComplete='off'
    ...
    <img src="/images/LineChart.png" className='chartimg' alt='Linechart'/>
    </div>
  </>
  );
}
